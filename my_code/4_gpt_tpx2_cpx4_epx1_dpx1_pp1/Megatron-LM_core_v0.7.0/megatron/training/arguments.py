...
def core_transformer_config_from_args(args, config_class=None):
    ...
    # Config class.
    config_class = config_class or TransformerConfig                           # trace_info : t_9152

    # Translate args to core transformer configuration
    kw_args = {}                                                               # trace_info : t_9153
    for f in dataclasses.fields(config_class):                                 # trace_info : t_9154, t_9157, t_9160, t_9163, t_9166, ...
        if hasattr(args, f.name):                                              # trace_info : t_9155, t_9158, t_9161, t_9164, t_9167, ...
            kw_args[f.name] = getattr(args, f.name)                            # trace_info : t_9156, t_9159, t_9162, t_9165, t_9168, ...
    kw_args['persist_layer_norm'] = not args.no_persist_layer_norm             # trace_info : t_9458
    kw_args['layernorm_zero_centered_gamma'] = args.apply_layernorm_1p         # trace_info : t_9459
    kw_args['layernorm_epsilon'] = args.norm_epsilon                           # trace_info : t_9460
    kw_args['deallocate_pipeline_outputs'] = True                              # trace_info : t_9461
    kw_args['pipeline_dtype'] = args.params_dtype                              # trace_info : t_9462
    kw_args['batch_p2p_comm'] = not args.overlap_p2p_comm                      # trace_info : t_9463
    kw_args['num_moe_experts'] = args.num_experts                              # trace_info : t_9464
    kw_args['rotary_interleaved'] = args.rotary_interleaved                    # trace_info : t_9465
    if args.swiglu:                                                            # trace_info : t_9466
        kw_args['activation_func'] = F.silu
        kw_args['gated_linear_unit'] = True
        kw_args['bias_activation_fusion'] = args.bias_swiglu_fusion
    else:
        kw_args['bias_activation_fusion'] = args.bias_gelu_fusion              # trace_info : t_9467
    if args.squared_relu:                                                      # trace_info : t_9468
    ...
    if args.init_method_xavier_uniform:                                        # trace_info : t_9469
        kw_args['init_method'] = torch.nn.init.xavier_uniform_
        kw_args['scaled_init_method'] = torch.nn.init.xavier_uniform_
    if args.group_query_attention:                                             # trace_info : t_9470
        kw_args['num_query_groups'] = args.num_query_groups
    else:
        kw_args['num_query_groups'] = None                                     # trace_info : t_9471

    # Return config.
    return config_class(**kw_args)                                             # trace_info : t_9472
