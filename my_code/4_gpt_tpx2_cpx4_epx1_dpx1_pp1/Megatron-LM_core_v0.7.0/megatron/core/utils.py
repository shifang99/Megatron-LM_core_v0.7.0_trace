...
def ensure_divisibility(numerator, denominator):
    ...
    assert numerator % denominator == 0, "{} is not divisible by {}".format(numerator, denominator)# trace_info : t_9766, t_10014, t_10018, t_10022, t_10793, ...


def divide(numerator, denominator):
    """Ensure that numerator is divisible by the denominator and return
    the division value."""
    ensure_divisibility(numerator, denominator)                                # trace_info : t_9765, t_10013, t_10017, t_10021, t_10792, ...
    return numerator // denominator                                            # trace_info : t_9767, t_10015, t_10019, t_10023, t_10794, ...
...
def get_attr_wrapped_model(model, attr, allow_none=True, return_model_obj=False):
    ...
    if isinstance(model, list):                                                # trace_info : t_12012, t_15793, t_17683, t_17703, t_17867, ...
        raise RuntimeError("_get_attr_wrapped_model given a list of models")

    if allow_none:                                                             # trace_info : t_12013, t_15794, t_17684, t_17704, t_17868, ...

        def condition(model, attr):                                            # trace_info : t_17705, t_17869, t_17891, t_18894, t_20891, ...
            return not hasattr(model, attr)                                    # trace_info : t_17707, t_17711, t_17715, t_17871, t_17875, ...

    else:

        def condition(model, attr):                                            # trace_info : t_12014, t_15795, t_17685, t_18995, t_20871, ...
            return getattr(model, attr, None) is None                          # trace_info : t_12016, t_12020, t_15797, t_17687, t_18997, ...

    while condition(model, attr):                                              # trace_info : t_12015, t_12019, t_15796, t_17686, t_17706, ...
        if not hasattr(model, "module"):                                       # trace_info : t_12017, t_17708, t_17712, t_17872, t_17876, ...
            raise RuntimeError(f"_get_attr_wrapped_model couldn't find attribute {attr}")

        model = model.module                                                   # trace_info : t_12018, t_17709, t_17713, t_17873, t_17877, ...

    if return_model_obj:                                                       # trace_info : t_12021, t_15798, t_17688, t_17716, t_17880, ...
        return model
    return getattr(model, attr)                                                # trace_info : t_12022, t_15799, t_17689, t_17717, t_17881, ...


def get_model_type(model):
    return get_attr_wrapped_model(model, 'model_type')                         # trace_info : t_17702, t_18891, t_20888, t_22077, t_24074, ...


def get_model_config(model):
    return get_attr_wrapped_model(model, 'config', allow_none=False)           # trace_info : t_12011, t_15792, t_17682, t_18992, t_20868, ...
...
def make_viewless_tensor(inp, requires_grad, keep_graph):
    ...
    if inp._base is None:                                                      # trace_info : t_18243, t_18449, t_18656, t_21429, t_21635, ...
        return inp                                                             # trace_info : t_18244, t_18450, t_18657, t_21430, t_21636, ...
...
def init_method_normal(sigma):
    ...
    def init_(tensor):                                                         # trace_info : t_9624
        return torch.nn.init.normal_(tensor, mean=0.0, std=sigma)              # trace_info : t_9824, t_9844, t_10298, t_10551, t_11076, ...

    return init_                                                               # trace_info : t_9625


def scaled_init_method_normal(sigma, num_layers):
    """Init method based on N(0, sigma/sqrt(2*num_layers)."""
    std = sigma / math.sqrt(2.0 * num_layers)                                  # trace_info : t_9630

    def init_(tensor):                                                         # trace_info : t_9631
        return torch.nn.init.normal_(tensor, mean=0.0, std=std)                # trace_info : t_10195, t_10662, t_10973, t_11440

    return init_                                                               # trace_info : t_9632
...
class StragglerDetector:
    ...
    def null_method(self) -> None:
        ...
        pass                                                                   # trace_info : t_17930, t_18135, t_18147, t_18828, t_21116, ...
    ...
    def __enter__(self) -> "StragglerDetector":
        ...
        """
        self.start()                                                           # trace_info : t_17929, t_18146, t_21115, t_21332, t_24301, ...
        return self                                                            # trace_info : t_17931, t_18148, t_21117, t_21334, t_24303, ...
    ...
    def __call__(self, bdata: bool = False) -> "StragglerDetector":
        ...
        Returns:
            StragglerDetector: the instance
        """
        self.bdata = bdata                                                     # trace_info : t_17927, t_21113, t_24299
        return self                                                            # trace_info : t_17928, t_21114, t_24300
    ...
    def __exit__(
        ...
        ret = False                                                            # trace_info : t_18132, t_18825, t_21318, t_22011, t_24504, ...
        if ex_type is not None:                                                # trace_info : t_18133, t_18826, t_21319, t_22012, t_24505, ...
            err = traceback.format_exception(ex_tb)
            logger.warning(f"{str(ex_val)}\n{err}")
            ret = True
        self.stop()                                                            # trace_info : t_18134, t_18827, t_21320, t_22013, t_24506, ...
        return ret                                                             # trace_info : t_18136, t_18829, t_21322, t_22015, t_24508, ...
