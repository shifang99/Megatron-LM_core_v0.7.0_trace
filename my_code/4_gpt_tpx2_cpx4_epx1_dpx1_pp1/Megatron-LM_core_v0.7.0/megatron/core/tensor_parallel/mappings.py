...
def _reduce(input_):
    ...
    if get_tensor_model_parallel_world_size() == 1:                            # trace_info : t_18206, t_21392, t_24578
        return input_

    # All-reduce.
    torch.distributed.all_reduce(input_, group=get_tensor_model_parallel_group())# trace_info : t_18212, t_21398, t_24584

    return input_                                                              # trace_info : t_18216, t_21402, t_24588
...
class _ReduceFromModelParallelRegion(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, input_):
        return _reduce(input_)                                                 # trace_info : t_18205, t_21391, t_24577
...
def reduce_from_tensor_model_parallel_region(input_):
    return _ReduceFromModelParallelRegion.apply(input_)                        # trace_info : t_18204, t_21390, t_24576
