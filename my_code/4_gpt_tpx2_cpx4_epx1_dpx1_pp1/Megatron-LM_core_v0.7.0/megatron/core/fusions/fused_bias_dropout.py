...
@jit_fuser                                                                     # trace_info : t_18390, t_18444, t_18597, t_18651, t_21576, ...
...
def get_bias_dropout_add(training, fused):
    if fused:                                                                  # trace_info : t_18385, t_18439, t_18592, t_18646, t_21571, ...
        # jit scripting for a nn.module (with dropout) is not
        # triggering the fusion kernel. For now, we use two
        # different nn.functional routines to account for varying
        # dropout semantics during training and inference phases.
        if training:                                                           # trace_info : t_18386, t_18440, t_18593, t_18647, t_21572, ...
            return bias_dropout_add_fused_train                                # trace_info : t_18387, t_18441, t_18594, t_18648, t_21573, ...
        else:
