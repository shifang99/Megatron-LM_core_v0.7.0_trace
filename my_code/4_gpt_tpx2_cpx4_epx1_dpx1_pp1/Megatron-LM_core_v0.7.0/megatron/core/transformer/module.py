...
def param_is_not_shared(param):
    return not hasattr(param, 'shared') or not param.shared                    # trace_info : t_19558, t_19567, t_19583, t_19592, t_19601, ...
...
class MegatronModule(torch.nn.Module):
    ...
    def __init__(self, config: TransformerConfig):
        super().__init__()                                                     # trace_info : t_9712, t_9734, t_9856, t_9921, t_9996, ...
        self.config = config                                                   # trace_info : t_9713, t_9735, t_9857, t_9922, t_9997, ...
    ...
    def set_is_first_microbatch(self):
        ...
        """
        for m in self.modules():                                               # trace_info : t_17750, t_17752, t_17754, t_17756, t_17758, ...
            if hasattr(m, "is_first_microbatch"):                              # trace_info : t_17751, t_17753, t_17755, t_17757, t_17759, ...
                m.is_first_microbatch = True                                   # trace_info : t_17788, t_17791, t_17808, t_17811, t_17832, ...
