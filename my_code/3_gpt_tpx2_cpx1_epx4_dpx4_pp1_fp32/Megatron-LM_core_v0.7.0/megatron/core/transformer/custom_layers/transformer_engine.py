...
def _get_extra_te_kwargs(config: TransformerConfig):
    extra_transformer_engine_kwargs = {                                        # trace_info : t_11845
        "params_dtype": config.params_dtype,                                   # trace_info : t_11844
    }

    if _te_version >= packaging.version.Version("0.12.0"):                     # trace_info : t_11846
        if config.use_cpu_initialization:                                      # trace_info : t_11847
            extra_transformer_engine_kwargs["device"] = 'cpu'
        else:
            extra_transformer_engine_kwargs["device"] = torch.cuda.current_device()# trace_info : t_11848
    return extra_transformer_engine_kwargs                                     # trace_info : t_11849
...
class TENorm:
    ...
    def __new__(
        ...
        if config.normalization == "LayerNorm":                                # trace_info : t_11836
            instance = te.pytorch.LayerNorm(                                   # trace_info : t_11837, t_11842, t_11850
                hidden_size=hidden_size,                                       # trace_info : t_11838
                eps=eps,                                                       # trace_info : t_11839
                sequence_parallel=config.sequence_parallel,                    # trace_info : t_11840
                zero_centered_gamma=config.layernorm_zero_centered_gamma,      # trace_info : t_11841
                **_get_extra_te_kwargs(config),                                # trace_info : t_11843
            )
        ...
        return instance                                                        # trace_info : t_11851
