...
def param_is_not_shared(param):
    return not hasattr(param, 'shared') or not param.shared                    # trace_info : t_20795, t_20804, t_20820, t_20829, t_20838, ...
...
class MegatronModule(torch.nn.Module):
    ...
    def __init__(self, config: TransformerConfig):
        super().__init__()                                                     # trace_info : t_9360, t_9382, t_9504, t_9569, t_9665, ...
        self.config = config                                                   # trace_info : t_9361, t_9383, t_9505, t_9570, t_9666, ...
    ...
    def set_is_first_microbatch(self):
        ...
        """
        for m in self.modules():                                               # trace_info : t_17917, t_17919, t_17921, t_17923, t_17925, ...
            if hasattr(m, "is_first_microbatch"):                              # trace_info : t_17918, t_17920, t_17922, t_17924, t_17926, ...
