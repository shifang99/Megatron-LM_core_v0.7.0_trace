...
@jit_fuser                                                                     # trace_info : t_18632, t_19080, t_19390, t_19835, t_22980, ...
...
def get_bias_dropout_add(training, fused):
    if fused:                                                                  # trace_info : t_18627, t_19075, t_19385, t_19830, t_22975, ...
        # jit scripting for a nn.module (with dropout) is not
        # triggering the fusion kernel. For now, we use two
        # different nn.functional routines to account for varying
        # dropout semantics during training and inference phases.
        if training:                                                           # trace_info : t_18628, t_19076, t_19386, t_19831, t_22976, ...
            return bias_dropout_add_fused_train                                # trace_info : t_18629, t_19077, t_19387, t_19832, t_22977, ...
        else:
