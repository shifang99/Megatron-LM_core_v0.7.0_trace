...
@jit_fuser                                                                     # trace_info : t_18711, t_18879, t_19204, t_19372, t_22439, ...
...
def get_bias_dropout_add(training, fused):
    if fused:                                                                  # trace_info : t_18706, t_18874, t_19199, t_19367, t_22434, ...
        # jit scripting for a nn.module (with dropout) is not
        # triggering the fusion kernel. For now, we use two
        # different nn.functional routines to account for varying
        # dropout semantics during training and inference phases.
        if training:                                                           # trace_info : t_18707, t_18875, t_19200, t_19368, t_22435, ...
            return bias_dropout_add_fused_train                                # trace_info : t_18708, t_18876, t_19201, t_19369, t_22436, ...
        else:
