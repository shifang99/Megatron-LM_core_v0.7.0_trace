...
def _reduce(input_):
    ...
    if get_tensor_model_parallel_world_size() == 1:                            # trace_info : t_18353, t_18688, t_18856, t_19181, t_19349, ...
        return input_

    # All-reduce.
    torch.distributed.all_reduce(input_, group=get_tensor_model_parallel_group())# trace_info : t_18359, t_18694, t_18862, t_19187, t_19355, ...

    return input_                                                              # trace_info : t_18363, t_18698, t_18866, t_19191, t_19359, ...
...
class _ReduceFromModelParallelRegion(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, input_):
        return _reduce(input_)                                                 # trace_info : t_18352, t_18687, t_18855, t_19180, t_19348, ...
...
def reduce_from_tensor_model_parallel_region(input_):
    return _ReduceFromModelParallelRegion.apply(input_)                        # trace_info : t_18351, t_18686, t_18854, t_19179, t_19347, ...
