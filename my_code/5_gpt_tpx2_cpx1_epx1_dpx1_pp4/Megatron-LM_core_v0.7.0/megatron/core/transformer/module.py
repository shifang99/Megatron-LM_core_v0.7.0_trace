...
def param_is_not_shared(param):
    return not hasattr(param, 'shared') or not param.shared                    # trace_info : t_20382, t_20391, t_20407, t_20416, t_20425, ...
...
class MegatronModule(torch.nn.Module):
    ...
    def __init__(self, config: TransformerConfig):
        super().__init__()                                                     # trace_info : t_9772, t_9794, t_9916, t_9981, t_10077, ...
        self.config = config                                                   # trace_info : t_9773, t_9795, t_9917, t_9982, t_10078, ...
    ...
    def set_is_first_microbatch(self):
        ...
        """
        for m in self.modules():                                               # trace_info : t_18037, t_18039, t_18041, t_18043, t_18045, ...
            if hasattr(m, "is_first_microbatch"):                              # trace_info : t_18038, t_18040, t_18042, t_18044, t_18046, ...
