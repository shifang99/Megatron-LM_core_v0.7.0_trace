...
def build_tokenizer(args):
    ...
    return tokenizer                                                           # trace_info : t_4275
...
def _vocab_size_with_padding(orig_vocab_size, args):
    ...
    if args.rank == 0:                                                         # trace_info : t_4267
        print(' > padded vocab (size: {}) with {} dummy tokens '               # trace_info : t_4268, t_4273
              '(new size: {})'.format(                                         # trace_info : t_4269, t_4271
                  orig_vocab_size, after - orig_vocab_size, after), flush=True)# trace_info : t_4270, t_4272
    return after                                                               # trace_info : t_4274
