...
def validate_args(args, defaults={}):
    ...
    if args.tensor_model_parallel_size == 1:                                   # trace_info : t_1224
        args.sequence_parallel = False                                         # trace_info : t_1225
...
def core_transformer_config_from_args(args, config_class=None):
    ...
    # Config class.
    config_class = config_class or TransformerConfig                           # trace_info : t_5842

    # Translate args to core transformer configuration
    kw_args = {}                                                               # trace_info : t_5843
    for f in dataclasses.fields(config_class):                                 # trace_info : t_5844, t_5847, t_5850, t_5853, t_5856, ...
        if hasattr(args, f.name):                                              # trace_info : t_5845, t_5848, t_5851, t_5854, t_5857, ...
            kw_args[f.name] = getattr(args, f.name)                            # trace_info : t_5846, t_5849, t_5852, t_5855, t_5858, ...
    kw_args['persist_layer_norm'] = not args.no_persist_layer_norm             # trace_info : t_6148
    kw_args['layernorm_zero_centered_gamma'] = args.apply_layernorm_1p         # trace_info : t_6149
    kw_args['layernorm_epsilon'] = args.norm_epsilon                           # trace_info : t_6150
    kw_args['deallocate_pipeline_outputs'] = True                              # trace_info : t_6151
    kw_args['pipeline_dtype'] = args.params_dtype                              # trace_info : t_6152
    kw_args['batch_p2p_comm'] = not args.overlap_p2p_comm                      # trace_info : t_6153
    kw_args['num_moe_experts'] = args.num_experts                              # trace_info : t_6154
    kw_args['rotary_interleaved'] = args.rotary_interleaved                    # trace_info : t_6155
    if args.swiglu:                                                            # trace_info : t_6156
        kw_args['activation_func'] = F.silu
        kw_args['gated_linear_unit'] = True
        kw_args['bias_activation_fusion'] = args.bias_swiglu_fusion
    else:
        kw_args['bias_activation_fusion'] = args.bias_gelu_fusion              # trace_info : t_6157
    if args.squared_relu:                                                      # trace_info : t_6158
    ...
    if args.init_method_xavier_uniform:                                        # trace_info : t_6159
        kw_args['init_method'] = torch.nn.init.xavier_uniform_
        kw_args['scaled_init_method'] = torch.nn.init.xavier_uniform_
    if args.group_query_attention:                                             # trace_info : t_6160
        kw_args['num_query_groups'] = args.num_query_groups
    else:
        kw_args['num_query_groups'] = None                                     # trace_info : t_6161

    # Return config.
    return config_class(**kw_args)                                             # trace_info : t_6162
