...
def maybe_finalize_async_save(blocking: bool = False):
    ...
    """
    args = get_args()                                                          # trace_info : t_14527, t_18112, t_21751, t_25398, t_25417
    if not args.async_save:                                                    # trace_info : t_14531, t_18116, t_21755, t_25402, t_25421
        return                                                                 # trace_info : t_14532, t_18117, t_21756, t_25403, t_25422
