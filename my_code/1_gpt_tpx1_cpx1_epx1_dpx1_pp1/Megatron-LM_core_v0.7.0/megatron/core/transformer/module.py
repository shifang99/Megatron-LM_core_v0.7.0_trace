...
def param_is_not_shared(param):
    return not hasattr(param, 'shared') or not param.shared                    # trace_info : t_17155, t_17164, t_17180, t_17189, t_17198, ...
...
class MegatronModule(torch.nn.Module):
    ...
    def __init__(self, config: TransformerConfig):
        super().__init__()                                                     # trace_info : t_6406, t_6428, t_6550, t_6615, t_6711, ...
        self.config = config                                                   # trace_info : t_6407, t_6429, t_6551, t_6616, t_6712, ...
    ...
    def set_is_first_microbatch(self):
        ...
        """
        for m in self.modules():                                               # trace_info : t_14892, t_14894, t_14896, t_14898, t_14900, ...
            if hasattr(m, "is_first_microbatch"):                              # trace_info : t_14893, t_14895, t_14897, t_14899, t_14901, ...
