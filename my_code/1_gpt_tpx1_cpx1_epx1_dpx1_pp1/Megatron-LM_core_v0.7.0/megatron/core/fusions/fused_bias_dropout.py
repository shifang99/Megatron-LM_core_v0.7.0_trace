...
@jit_fuser                                                                     # trace_info : t_15576, t_15748, t_16077, t_16249, t_19215, ...
...
def get_bias_dropout_add(training, fused):
    if fused:                                                                  # trace_info : t_15571, t_15743, t_16072, t_16244, t_19210, ...
        # jit scripting for a nn.module (with dropout) is not
        # triggering the fusion kernel. For now, we use two
        # different nn.functional routines to account for varying
        # dropout semantics during training and inference phases.
        if training:                                                           # trace_info : t_15572, t_15744, t_16073, t_16245, t_19211, ...
            return bias_dropout_add_fused_train                                # trace_info : t_15573, t_15745, t_16074, t_16246, t_19212, ...
        else:
