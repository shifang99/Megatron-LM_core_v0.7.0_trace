...
def _reduce(input_):
    ...
    if get_tensor_model_parallel_world_size() == 1:                            # trace_info : t_15218, t_15557, t_15729, t_16058, t_16230, ...
        return input_                                                          # trace_info : t_15224, t_15563, t_15735, t_16064, t_16236, ...
...
class _CopyToModelParallelRegion(torch.autograd.Function):
    ...
    def forward(ctx, input_):
        return input_                                                          # trace_info : t_15315, t_15632, t_15818, t_16133, t_16290, ...
...
class _ReduceFromModelParallelRegion(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, input_):
        return _reduce(input_)                                                 # trace_info : t_15217, t_15556, t_15728, t_16057, t_16229, ...
...
def copy_to_tensor_model_parallel_region(input_):
    return _CopyToModelParallelRegion.apply(input_)                            # trace_info : t_15314, t_15631, t_15817, t_16132, t_16289, ...


def reduce_from_tensor_model_parallel_region(input_):
    return _ReduceFromModelParallelRegion.apply(input_)                        # trace_info : t_15216, t_15555, t_15727, t_16056, t_16228, ...
