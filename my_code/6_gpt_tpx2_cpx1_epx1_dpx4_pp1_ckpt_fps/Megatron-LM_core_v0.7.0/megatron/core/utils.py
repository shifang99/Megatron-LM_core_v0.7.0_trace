...
def ensure_divisibility(numerator, denominator):
    ...
    assert numerator % denominator == 0, "{} is not divisible by {}".format(numerator, denominator)# trace_info : t_9489, t_9758, t_9762, t_9766, t_9807, ...


def divide(numerator, denominator):
    """Ensure that numerator is divisible by the denominator and return
    the division value."""
    ensure_divisibility(numerator, denominator)                                # trace_info : t_9488, t_9757, t_9761, t_9765, t_9806, ...
    return numerator // denominator                                            # trace_info : t_9490, t_9759, t_9763, t_9767, t_9808, ...
...
def get_attr_wrapped_model(model, attr, allow_none=True, return_model_obj=False):
    ...
    if isinstance(model, list):                                                # trace_info : t_12182, t_15963, t_17961, t_17981, t_18125, ...
        raise RuntimeError("_get_attr_wrapped_model given a list of models")

    if allow_none:                                                             # trace_info : t_12183, t_15964, t_17962, t_17982, t_18126, ...

        def condition(model, attr):                                            # trace_info : t_17983, t_18127, t_18149, t_19624, t_21622, ...
            return not hasattr(model, attr)                                    # trace_info : t_17985, t_17989, t_17993, t_18129, t_18133, ...

    else:

        def condition(model, attr):                                            # trace_info : t_12184, t_15965, t_17963, t_19725, t_21602, ...
            return getattr(model, attr, None) is None                          # trace_info : t_12186, t_12190, t_15967, t_17965, t_19727, ...

    while condition(model, attr):                                              # trace_info : t_12185, t_12189, t_15966, t_17964, t_17984, ...
        if not hasattr(model, "module"):                                       # trace_info : t_12187, t_17986, t_17990, t_18130, t_18134, ...
            raise RuntimeError(f"_get_attr_wrapped_model couldn't find attribute {attr}")

        model = model.module                                                   # trace_info : t_12188, t_17987, t_17991, t_18131, t_18135, ...

    if return_model_obj:                                                       # trace_info : t_12191, t_15968, t_17966, t_17994, t_18138, ...
        return model
    return getattr(model, attr)                                                # trace_info : t_12192, t_15969, t_17967, t_17995, t_18139, ...


def get_model_type(model):
    return get_attr_wrapped_model(model, 'model_type')                         # trace_info : t_17980, t_19621, t_21619, t_23258, t_89226, ...


def get_model_config(model):
    return get_attr_wrapped_model(model, 'config', allow_none=False)           # trace_info : t_12181, t_15962, t_17960, t_19722, t_21599, ...
...
class GlobalMemoryBuffer:
    ...
    def __init__(self):
        self.buffer = {}                                                       # trace_info : t_8399

    def get_tensor(self, tensor_shape, dtype, name):
        required_len = reduce(operator.mul, tensor_shape, 1)                   # trace_info : t_18561, t_19056, t_22200, t_22693, t_89807, ...
        if (
            self.buffer.get((name, dtype), None) is None                       # trace_info : t_18562, t_19057, t_22201, t_22694, t_89808, ...
            or self.buffer[(name, dtype)].numel() < required_len               # trace_info : t_19058, t_22202, t_22695, t_89809, t_90302
        ):
            self.buffer[(name, dtype)] = torch.empty(                          # trace_info : t_18563, t_18565
                required_len, dtype=dtype, device=torch.cuda.current_device(), requires_grad=False# trace_info : t_18564
            )

        return self.buffer[(name, dtype)][0:required_len].view(*tensor_shape)  # trace_info : t_18566, t_19059, t_22203, t_22696, t_89810, ...
...
def _kernel_make_viewless_tensor(inp, requires_grad):
    ...
    field.
    '''
    out = torch.empty((1,), dtype=inp.dtype, device=inp.device, requires_grad=requires_grad,)# trace_info : t_18438, t_18759, t_18933, t_19252, t_22077, ...
    out.data = inp.data                                                        # trace_info : t_18439, t_18760, t_18934, t_19253, t_22078, ...
    return out                                                                 # trace_info : t_18440, t_18761, t_18935, t_19254, t_22079, ...
...
class MakeViewlessTensor(torch.autograd.Function):
    ...
    def forward(ctx, inp, requires_grad):
        return _kernel_make_viewless_tensor(inp, requires_grad)                # trace_info : t_18437, t_18758, t_18932, t_19251, t_22076, ...
...
def make_viewless_tensor(inp, requires_grad, keep_graph):
    ...
    if inp._base is None:                                                      # trace_info : t_18403, t_18434, t_18755, t_18897, t_18929, ...
        return inp                                                             # trace_info : t_18404, t_18898, t_19391, t_22043, t_22535, ...

    # create viewless tensor
    if keep_graph:                                                             # trace_info : t_18435, t_18756, t_18930, t_19249, t_22074, ...
        return MakeViewlessTensor.apply(inp, requires_grad)                    # trace_info : t_18436, t_18757, t_18931, t_19250, t_22075, ...
    else:
...
def init_method_normal(sigma):
    ...
    def init_(tensor):                                                         # trace_info : t_9343
        return torch.nn.init.normal_(tensor, mean=0.0, std=sigma)              # trace_info : t_9547, t_9567, t_10100, t_10429, t_11102, ...

    return init_                                                               # trace_info : t_9344


def scaled_init_method_normal(sigma, num_layers):
    """Init method based on N(0, sigma/sqrt(2*num_layers)."""
    std = sigma / math.sqrt(2.0 * num_layers)                                  # trace_info : t_9349

    def init_(tensor):                                                         # trace_info : t_9350
        return torch.nn.init.normal_(tensor, mean=0.0, std=std)                # trace_info : t_9958, t_10587, t_10960, t_11589

    return init_                                                               # trace_info : t_9351
...
def make_tp_sharded_tensor_for_checkpoint(
    ...
    prepend_axis_num = len(prepend_offsets)                                    # trace_info : t_25098, t_25580, t_25802, t_25894, t_26283, ...

    if replica_id is None:                                                     # trace_info : t_25099, t_25581, t_25803, t_25895, t_26284, ...
        replica_id = (0, 0, parallel_state.get_data_parallel_rank(with_context_parallel=True))# trace_info : t_25100, t_25582, t_25804, t_25896, t_26285, ...

    return ShardedTensor.from_rank_offsets(                                    # trace_info : t_25108, t_25111, t_25113, t_25128, t_25131, ...
        key,                                                                   # trace_info : t_25109, t_25591, t_25813, t_25905, t_26294, ...
        tensor,                                                                # trace_info : t_25110, t_25592, t_25814, t_25906, t_26295, ...
        *prepend_offsets,                                                      # trace_info : t_25112, t_25594, t_25816, t_25908, t_26297, ...
        (                                                                      # trace_info : t_25127, t_25609, t_25831, t_25923, t_26312, ...
            tp_axis + prepend_axis_num,                                        # trace_info : t_25114, t_25596, t_25818, t_25910, t_26299, ...
            parallel_state.get_tensor_model_parallel_rank(),                   # trace_info : t_25115, t_25597, t_25819, t_25911, t_26300, ...
            parallel_state.get_tensor_model_parallel_world_size(),             # trace_info : t_25121, t_25603, t_25825, t_25917, t_26306, ...
        ),
        replica_id=replica_id,                                                 # trace_info : t_25129, t_25611, t_25833, t_25925, t_26314, ...
        prepend_axis_num=prepend_axis_num,                                     # trace_info : t_25130, t_25612, t_25834, t_25926, t_26315, ...
        **kwargs,                                                              # trace_info : t_25132, t_25614, t_25836, t_25928, t_26317, ...
    )
...
def make_sharded_tensor_for_checkpoint(tensor, key, prepend_offsets=(), replica_id=None, **kwargs):
    ...
    prepend_axis_num = len(prepend_offsets)                                    # trace_info : t_25193, t_25345, t_25420, t_25671, t_26110, ...

    if replica_id is None:                                                     # trace_info : t_25194, t_25346, t_25421, t_25672, t_26111, ...
        replica_id = (                                                         # trace_info : t_25210, t_25362, t_25437, t_25688, t_26127, ...
            0,                                                                 # trace_info : t_25195, t_25347, t_25422, t_25673, t_26112, ...
            parallel_state.get_tensor_model_parallel_rank(),                   # trace_info : t_25196, t_25348, t_25423, t_25674, t_26113, ...
            parallel_state.get_data_parallel_rank(with_context_parallel=True), # trace_info : t_25202, t_25354, t_25429, t_25680, t_26119, ...
        )

    return ShardedTensor.from_rank_offsets(                                    # trace_info : t_25211, t_25214, t_25216, t_25219, t_25221, ...
        key,                                                                   # trace_info : t_25212, t_25364, t_25439, t_25690, t_26129, ...
        tensor,                                                                # trace_info : t_25213, t_25365, t_25440, t_25691, t_26130, ...
        *prepend_offsets,                                                      # trace_info : t_25215, t_25367, t_25442, t_25693, t_26132, ...
        replica_id=replica_id,                                                 # trace_info : t_25217, t_25369, t_25444, t_25695, t_26134, ...
        prepend_axis_num=prepend_axis_num,                                     # trace_info : t_25218, t_25370, t_25445, t_25696, t_26135, ...
        **kwargs,                                                              # trace_info : t_25220, t_25372, t_25447, t_25698, t_26137, ...
    )
...
class StragglerDetector:
    ...
    def null_method(self) -> None:
        ...
        pass                                                                   # trace_info : t_18188, t_18295, t_18307, t_19562, t_21827, ...
    ...
    def __enter__(self) -> "StragglerDetector":
        ...
        """
        self.start()                                                           # trace_info : t_18187, t_18306, t_21826, t_21945, t_89433, ...
        return self                                                            # trace_info : t_18189, t_18308, t_21828, t_21947, t_89435, ...
    ...
    def __call__(self, bdata: bool = False) -> "StragglerDetector":
        ...
        Returns:
            StragglerDetector: the instance
        """
        self.bdata = bdata                                                     # trace_info : t_18185, t_21824, t_89431
        return self                                                            # trace_info : t_18186, t_21825, t_89432
    ...
    def __exit__(
        ...
        ret = False                                                            # trace_info : t_18292, t_19559, t_21931, t_23196, t_89538, ...
        if ex_type is not None:                                                # trace_info : t_18293, t_19560, t_21932, t_23197, t_89539, ...
            err = traceback.format_exception(ex_tb)
            logger.warning(f"{str(ex_val)}\n{err}")
            ret = True
        self.stop()                                                            # trace_info : t_18294, t_19561, t_21933, t_23198, t_89540, ...
        return ret                                                             # trace_info : t_18296, t_19563, t_21935, t_23200, t_89542, ...
