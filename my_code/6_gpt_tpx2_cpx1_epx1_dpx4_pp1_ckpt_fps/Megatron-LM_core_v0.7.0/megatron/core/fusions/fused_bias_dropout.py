...
@jit_fuser                                                                     # trace_info : t_18724, t_18892, t_19217, t_19385, t_22361, ...
...
def get_bias_dropout_add(training, fused):
    if fused:                                                                  # trace_info : t_18719, t_18887, t_19212, t_19380, t_22356, ...
        # jit scripting for a nn.module (with dropout) is not
        # triggering the fusion kernel. For now, we use two
        # different nn.functional routines to account for varying
        # dropout semantics during training and inference phases.
        if training:                                                           # trace_info : t_18720, t_18888, t_19213, t_19381, t_22357, ...
            return bias_dropout_add_fused_train                                # trace_info : t_18721, t_18889, t_19214, t_19382, t_22358, ...
        else:
