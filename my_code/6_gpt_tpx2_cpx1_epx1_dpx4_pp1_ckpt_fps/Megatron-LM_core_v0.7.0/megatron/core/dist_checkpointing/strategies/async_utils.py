...
class AsyncRequest(NamedTuple):
    ...
    def execute_sync(self) -> None:
        ...
        """
        if self.async_fn is not None:                                          # trace_info : t_88675, t_156042
            self.async_fn(*self.async_fn_args)                                 # trace_info : t_88676, t_156043
        torch.distributed.barrier()                                            # trace_info : t_88696, t_156063
        for finalize_fn in self.finalize_fns:                                  # trace_info : t_88697, t_88720, t_156064, t_156087
            finalize_fn()                                                      # trace_info : t_88698, t_156065
