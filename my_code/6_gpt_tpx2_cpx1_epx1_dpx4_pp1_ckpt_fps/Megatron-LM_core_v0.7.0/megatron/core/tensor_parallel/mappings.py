...
def _reduce(input_):
    ...
    if get_tensor_model_parallel_world_size() == 1:                            # trace_info : t_18366, t_18701, t_18869, t_19194, t_19362, ...
        return input_

    # All-reduce.
    torch.distributed.all_reduce(input_, group=get_tensor_model_parallel_group())# trace_info : t_18372, t_18707, t_18875, t_19200, t_19368, ...

    return input_                                                              # trace_info : t_18376, t_18711, t_18879, t_19204, t_19372, ...
...
class _ReduceFromModelParallelRegion(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, input_):
        return _reduce(input_)                                                 # trace_info : t_18365, t_18700, t_18868, t_19193, t_19361, ...
...
def reduce_from_tensor_model_parallel_region(input_):
    return _ReduceFromModelParallelRegion.apply(input_)                        # trace_info : t_18364, t_18699, t_18867, t_19192, t_19360, ...
