...
def _get_extra_te_kwargs(config: TransformerConfig):
    extra_transformer_engine_kwargs = {                                        # trace_info : t_11644
        "params_dtype": config.params_dtype,                                   # trace_info : t_11643
    }

    if _te_version >= packaging.version.Version("0.12.0"):                     # trace_info : t_11645
        if config.use_cpu_initialization:                                      # trace_info : t_11646
            extra_transformer_engine_kwargs["device"] = 'cpu'
        else:
            extra_transformer_engine_kwargs["device"] = torch.cuda.current_device()# trace_info : t_11647
    return extra_transformer_engine_kwargs                                     # trace_info : t_11648
...
class TENorm:
    ...
    def __new__(
        ...
        if config.normalization == "LayerNorm":                                # trace_info : t_11635
            instance = te.pytorch.LayerNorm(                                   # trace_info : t_11636, t_11641, t_11649
                hidden_size=hidden_size,                                       # trace_info : t_11637
                eps=eps,                                                       # trace_info : t_11638
                sequence_parallel=config.sequence_parallel,                    # trace_info : t_11639
                zero_centered_gamma=config.layernorm_zero_centered_gamma,      # trace_info : t_11640
                **_get_extra_te_kwargs(config),                                # trace_info : t_11642
            )
        ...
        return instance                                                        # trace_info : t_11650
