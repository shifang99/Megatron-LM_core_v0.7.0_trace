...
def param_is_not_shared(param):
    return not hasattr(param, 'shared') or not param.shared                    # trace_info : t_20288, t_20297, t_20313, t_20322, t_20331, ...
...
class MegatronModule(torch.nn.Module):
    ...
    def __init__(self, config: TransformerConfig):
        super().__init__()                                                     # trace_info : t_9435, t_9457, t_9579, t_9644, t_9740, ...
        self.config = config                                                   # trace_info : t_9436, t_9458, t_9580, t_9645, t_9741, ...
    ...
    def sharded_state_dict(
        ...
        """
        sharded_state_dict = {}                                                # trace_info : t_25056, t_25073, t_25317, t_25498, t_25515, ...
        # Save parameters
        self._save_to_state_dict(sharded_state_dict, '', keep_vars=True)       # trace_info : t_25057, t_25074, t_25318, t_25499, t_25516, ...
        sharded_state_dict = make_sharded_tensors_for_checkpoint(              # trace_info : t_25058, t_25060, t_25075, t_25077, t_25319, ...
            sharded_state_dict, prefix, sharded_offsets=sharded_offsets        # trace_info : t_25059, t_25076, t_25320, t_25501, t_25518, ...
        )
        # Recurse into submodules
        for name, module in self.named_children():                             # trace_info : t_25066, t_25083, t_25175, t_25255, t_25269, ...
            sharded_state_dict.update(                                         # trace_info : t_25067, t_25084, t_25174, t_25176, t_25254, ...
                sharded_state_dict_default(module, f'{prefix}{name}.', sharded_offsets, metadata)# trace_info : t_25068, t_25085, t_25177, t_25257, t_25275, ...
            )
        return sharded_state_dict                                              # trace_info : t_25270, t_25554, t_26047, t_26720, t_27348, ...
    ...
    def set_is_first_microbatch(self):
        ...
        """
        for m in self.modules():                                               # trace_info : t_18028, t_18030, t_18032, t_18034, t_18036, ...
            if hasattr(m, "is_first_microbatch"):                              # trace_info : t_18029, t_18031, t_18033, t_18035, t_18037, ...
