...
def validate_args(args, defaults={}):
    ...
    if args.save is not None:                                                  # trace_info : t_1210
        assert args.save_interval is not None                                  # trace_info : t_1211
...
def core_transformer_config_from_args(args, config_class=None):
    ...
    # Config class.
    config_class = config_class or TransformerConfig                           # trace_info : t_8871

    # Translate args to core transformer configuration
    kw_args = {}                                                               # trace_info : t_8872
    for f in dataclasses.fields(config_class):                                 # trace_info : t_8873, t_8876, t_8879, t_8882, t_8885, ...
        if hasattr(args, f.name):                                              # trace_info : t_8874, t_8877, t_8880, t_8883, t_8886, ...
            kw_args[f.name] = getattr(args, f.name)                            # trace_info : t_8875, t_8878, t_8881, t_8884, t_8887, ...
    kw_args['persist_layer_norm'] = not args.no_persist_layer_norm             # trace_info : t_9177
    kw_args['layernorm_zero_centered_gamma'] = args.apply_layernorm_1p         # trace_info : t_9178
    kw_args['layernorm_epsilon'] = args.norm_epsilon                           # trace_info : t_9179
    kw_args['deallocate_pipeline_outputs'] = True                              # trace_info : t_9180
    kw_args['pipeline_dtype'] = args.params_dtype                              # trace_info : t_9181
    kw_args['batch_p2p_comm'] = not args.overlap_p2p_comm                      # trace_info : t_9182
    kw_args['num_moe_experts'] = args.num_experts                              # trace_info : t_9183
    kw_args['rotary_interleaved'] = args.rotary_interleaved                    # trace_info : t_9184
    if args.swiglu:                                                            # trace_info : t_9185
        kw_args['activation_func'] = F.silu
        kw_args['gated_linear_unit'] = True
        kw_args['bias_activation_fusion'] = args.bias_swiglu_fusion
    else:
        kw_args['bias_activation_fusion'] = args.bias_gelu_fusion              # trace_info : t_9186
    if args.squared_relu:                                                      # trace_info : t_9187
    ...
    if args.init_method_xavier_uniform:                                        # trace_info : t_9188
        kw_args['init_method'] = torch.nn.init.xavier_uniform_
        kw_args['scaled_init_method'] = torch.nn.init.xavier_uniform_
    if args.group_query_attention:                                             # trace_info : t_9189
        kw_args['num_query_groups'] = args.num_query_groups
    else:
        kw_args['num_query_groups'] = None                                     # trace_info : t_9190

    # Return config.
    return config_class(**kw_args)                                             # trace_info : t_9191
