...
def maybe_finalize_async_save(blocking: bool = False):
    ...
    """
    args = get_args()                                                          # trace_info : t_19393, t_22949, t_26559, t_30177, t_30196
    if not args.async_save:                                                    # trace_info : t_19397, t_22953, t_26563, t_30181, t_30200
        return                                                                 # trace_info : t_19398, t_22954, t_26564, t_30182, t_30201
