...
def _reduce(input_):
    ...
    if get_tensor_model_parallel_world_size() == 1:                            # trace_info : t_20087, t_20414, t_20582, t_20899, t_21067, ...
        return input_

    # All-reduce.
    torch.distributed.all_reduce(input_, group=get_tensor_model_parallel_group())# trace_info : t_20093, t_20420, t_20588, t_20905, t_21073, ...

    return input_                                                              # trace_info : t_20097, t_20424, t_20592, t_20909, t_21077, ...
...
class _ReduceFromModelParallelRegion(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, input_):
        return _reduce(input_)                                                 # trace_info : t_20086, t_20413, t_20581, t_20898, t_21066, ...
...
def reduce_from_tensor_model_parallel_region(input_):
    return _ReduceFromModelParallelRegion.apply(input_)                        # trace_info : t_20085, t_20412, t_20580, t_20897, t_21065, ...
