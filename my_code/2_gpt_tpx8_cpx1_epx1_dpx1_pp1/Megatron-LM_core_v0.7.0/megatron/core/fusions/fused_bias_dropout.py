...
@jit_fuser                                                                     # trace_info : t_20437, t_20605, t_20922, t_21090, t_24047, ...
...
def get_bias_dropout_add(training, fused):
    if fused:                                                                  # trace_info : t_20432, t_20600, t_20917, t_21085, t_24042, ...
        # jit scripting for a nn.module (with dropout) is not
        # triggering the fusion kernel. For now, we use two
        # different nn.functional routines to account for varying
        # dropout semantics during training and inference phases.
        if training:                                                           # trace_info : t_20433, t_20601, t_20918, t_21086, t_24043, ...
            return bias_dropout_add_fused_train                                # trace_info : t_20434, t_20602, t_20919, t_21087, t_24044, ...
        else:
