...
def param_is_not_shared(param):
    return not hasattr(param, 'shared') or not param.shared                    # trace_info : t_21992, t_22001, t_22017, t_22026, t_22035, ...
...
class MegatronModule(torch.nn.Module):
    ...
    def __init__(self, config: TransformerConfig):
        super().__init__()                                                     # trace_info : t_11273, t_11295, t_11417, t_11482, t_11578, ...
        self.config = config                                                   # trace_info : t_11274, t_11296, t_11418, t_11483, t_11579, ...
    ...
    def set_is_first_microbatch(self):
        ...
        """
        for m in self.modules():                                               # trace_info : t_19758, t_19760, t_19762, t_19764, t_19766, ...
            if hasattr(m, "is_first_microbatch"):                              # trace_info : t_19759, t_19761, t_19763, t_19765, t_19767, ...
