...
def _get_extra_te_kwargs(config: TransformerConfig):
    extra_transformer_engine_kwargs = {                                        # trace_info : t_13482
        "params_dtype": config.params_dtype,                                   # trace_info : t_13481
    }

    if _te_version >= packaging.version.Version("0.12.0"):                     # trace_info : t_13483
        if config.use_cpu_initialization:                                      # trace_info : t_13484
            extra_transformer_engine_kwargs["device"] = 'cpu'
        else:
            extra_transformer_engine_kwargs["device"] = torch.cuda.current_device()# trace_info : t_13485
    return extra_transformer_engine_kwargs                                     # trace_info : t_13486
...
class TENorm:
    ...
    def __new__(
        ...
        if config.normalization == "LayerNorm":                                # trace_info : t_13473
            instance = te.pytorch.LayerNorm(                                   # trace_info : t_13474, t_13479, t_13487
                hidden_size=hidden_size,                                       # trace_info : t_13475
                eps=eps,                                                       # trace_info : t_13476
                sequence_parallel=config.sequence_parallel,                    # trace_info : t_13477
                zero_centered_gamma=config.layernorm_zero_centered_gamma,      # trace_info : t_13478
                **_get_extra_te_kwargs(config),                                # trace_info : t_13480
            )
        ...
        return instance                                                        # trace_info : t_13488
